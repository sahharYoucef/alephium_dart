...
class _BlockFlowClient implements BlockFlowClient {
  _BlockFlowClient(this._dio, {this.baseUrl});
  ...
  @override
  Future<HashesAtHeight> getBlockFlowHashes(fromGroup, toGroup, height,
      {params}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
  ...
  @override
  Future<BlockHeaderEntry> getBlockFlowHeadersBlockHash(blockHash,
      {params}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'blockHash': blockHash};
    queryParameters.removeWhere((k, v) => v == null);
